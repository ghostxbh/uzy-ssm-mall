            ...
            <div class="bd">
                ...
                <script>
                    function confirmOrder() {
                        ...
                        if (yn) {
                            $.ajax({
                                url: "/bookstore/order/success/${requestScope.productOrder.productOrder_code}",
                                type: "PUT",
                                data: null,
                                dataType: "json",
                                success: function (data) {
                                    if (data.success) {
                                        location.href = "/bookstore/order/success/${requestScope.productOrder.productOrder_code}";
                                    } else {
                                        alert("订单确认异常，请稍后再试！");
                                        location.href = "/bookstore/order/0/10";
                                    }
                                },
                                error: function (data) {
                                    alert("订单确认异常，请稍后再试！");
