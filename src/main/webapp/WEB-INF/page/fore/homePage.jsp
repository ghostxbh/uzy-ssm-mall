...
<script>
    ...
    <div class="header">
         <a href="${pageContext.request.contextPath}"><img src="${pageContext.request.contextPath}/res/images/fore/WebsiteImage/logo.png"></a>
    ...
    <div class="header-wrap">
	    <div class="home_nav">
		   <a href="${pageContext.request.contextPath}"><img src="${pageContext.request.contextPath}/res/images/fore/WebsiteImage/bookstoresmal.png"></a>
		        <div class="mallSearch">
	            <form action="${pageContext.request.contextPath}/product" method="get">
	                <div class="mallSearch-input">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="5000">
        ...
        <div class="carousel-inner">
            <div class="item  active">
                <div class="carousel-image" style="background-image:url(/bookstore/res/images/fore/WebsiteImage/banner/60.jpg);background-size:100% 100%;">
            ...
            <div class="item">
                <div class="carousel-image"
                     style="background-image: url(/bookstore/res/images/fore/WebsiteImage/banner/61.jpg);background-size:100% 100%;">
            ...
            <div class="item">
                <div class="carousel-image"
                     style="background-image: url(/bookstore/res/images/fore/WebsiteImage/banner/44.jpg);background-size:100% 100%;">
                    <div class="carousel-caption "></div>
                </div>
            </div>
            ...
            <!-- <div class="item">
                <div class="carousel-image"
                     style="background-image: url(/bookstore/res/images/fore/WebsiteImage/banner/43.jpg);background-size:100% 100%;">
                    <div class="carousel-caption "></div>
                </div>
            </div> -->
