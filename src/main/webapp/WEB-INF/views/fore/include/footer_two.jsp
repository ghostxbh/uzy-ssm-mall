...
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/fore/fore_foot_two.css"/>
     ...
     <!--    <dl>
       ...
       <%--  <dl>
            ...
            <dd><a href="http://mobile.tmall.com/?spm=875.7931836/B.a2226n1.23.71ca4265hUvhyq" class="join"><img
                    src="${pageContext.request.contextPath}/static/images/fore/WebsiteImage/TB14VZKHXXXXXcAXXXX64VRZFXX-105-105.png"
                    width="105" height="105" alt="手机"></a>
            </dd>
        </dl> --%>
   <!--  </div> -->
</div>